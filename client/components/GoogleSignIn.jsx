const GoogleSignIn = ({ className }) => {
  ...
  return (
    <button type="button" onClick={googleSignIn} className={'bg-blue-500 border text-white rounded-md h-fit text-left '+className}>
        ...
        <span className='inline-block px-2'>Continue with Google</span>
    </button>
  )
}
